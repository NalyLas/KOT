...
public class SummaryDay extends Fragment {
    ...
    private ArrayList<ChartTask> chartList;
    private int cod,tu = 0,tnu = 0;
    ...
    class GetChartNormalTask extends AsyncTask<String, String, JSONArray> {
        ...
        protected JSONArray doInBackground(String... args) {
            ...
            try {
                ...
                parametrosPost.put("ins_sql", "SELECT COUNT(*) AS total_number, `End_date` AS fecha FROM `TASK` WHERE `User`= "+cod+" AND `End_date` = '"+ date +"'");
